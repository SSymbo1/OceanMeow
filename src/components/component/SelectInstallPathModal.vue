...
import { ref } from 'vue'
import { DropboxOutlined, InboxOutlined } from '@ant-design/icons-vue'
...
<template>
    <a-modal :open="visiable" centered title="请手动选择Steam安装路径" :footer="null" :closable="false">
        <div class="min-h-70 flex flex-row gap-7 items-center">
            ...
            <div class="flex flex-col gap-8">
                ...
                <div class="relative">
                    <a-upload-dragger :show-upload-list="false" :before-upload="() => false" :custom-request="() => { }"
                        :open-file-dialog-on-click="false" class="pl-1.5 pr-1.5">
                    ...
                    <div class="absolute inset-0 cursor-pointer" @click="handleUploaderSelectFile"
                        @drop="handleUploaderDragFile" @dragover.prevent>
                    </div>
                </div>
            </div>
        </div>
